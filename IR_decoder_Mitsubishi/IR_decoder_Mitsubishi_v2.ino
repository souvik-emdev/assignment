...
void setswing(bool hsw, bool vsw){
  if (hsw){ir_out2[5]=0x7F; ir_out2[6]=0x80;}
  else {ir_out2[5]=0xFF; ir_out2[6]=0x00;}
  if (vsw){ir_out2[7]-=0x10; ir_out2[8]+=0x10;}
}

void setfan(uint8_t fan){
  ir_out2[7]=0x0F;
  ir_out2[8]=0x00;
  if (fan==1){ir_out2[7] |= 0xF0; ir_out2[8] |= 0x0;}
  else if (fan==2){ir_out2[7] |= 0x70; ir_out2[8] |= 0x80;}
  else if (fan==3){ir_out2[7] |= 0x90; ir_out2[8] |= 0x60;} 
  else if (fan==4){ir_out2[7] |= 0xB0; ir_out2[8] |= 0x40;}
}
...
void setmode(uint8_t mode){
  ...
  if (mode == 1){ir_out2[9]=0x27; ir_out2[10]=0xD8; p_m=1;} //fan
  else if (mode == 2){ir_out2[9]|=0x06; ir_out2[10]|=0x09; p_m=2;} //cool
  else if (mode == 3){ir_out2[9]|=0x03; ir_out2[10]|=0x0C; p_m=3;} //heat
  else if (mode == 4){ir_out2[9]|=0x05; ir_out2[10]|=0x0A; p_m=4;} //dry
  else if (mode == 5){                                     //Off. Depends on the previous mode
    if (p_m == 1){ir_out2[9]|=0x0F; ir_out2[10]|=0x00;}
    else if (p_m == 2){ir_out2[9]|=0x0E; ir_out2[10]|=0x01;}
    else if (p_m == 3){ir_out2[9]|=0x0B; ir_out2[11]|=0x04;}
    else if (p_m == 4){ir_out2[9]|=0x0D; ir_out2[11]|=0x02;}
  }
}

/*
v1.0
Encoder files for Blue Star AC
Protocol : ELECTROLUX96_192AC
AC model : Blue Star RG66B8(2H)/BGEF
*/
...
var xyz = {};
xyz.power = 1;
xyz.temp = 17; //range 17-30
xyz.fan = "auto"; //1, 2, 3, or auto
//xyz.hsw = 1; not available in this model
xyz.vsw = 0;
xyz.mode = 1; //Cool=1, auto=2, fan=3, heat=4, dry=5
xyz.change = 3;
ir_generator(xyz);